...
public partial class mis_Legal_OldCaseDashBoard : System.Web.UI.Page
{
    ...
    protected void BindCaseTypeCount()
    {
        ...
        str += "<table border='1' style='text-align:center;color:darkcyan;font-size:17px;height:573px;width:100%;'><tr style='background-color: #fff;'><td style='font-weight:bold;color: black;width: 87px;'>Case Type</td><td style='font-weight:bold;color: black;word-wrap: break-word'>Pending Cases Since 2000</td></tr>";
        int tCount = 0;
        int tCount1 = 0;
