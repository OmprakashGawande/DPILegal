        ...
        try
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["HOD_Section_ID"].ToString()))
                {
                    ...
                    ddlSection.ClearSelection();
                    ddlSection.Items.FindByValue(ds.Tables[0].Rows[0]["HOD_Section_ID"].ToString().Trim()).Selected = true;
                }
            }
        }
        catch (Exception ex)
        ...
        try
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["CaseSubSubj_Id"].ToString()))
                {
                    ...
                    int OICId = ReutrnSubSubjectID().AsEnumerable().Where(r => r.Field<int>("CaseSubSubj_Id") == Convert.ToInt32(ds.Tables[0].Rows[0]["CaseSubSubj_Id"])).Select(y => y.Field<int>("CaseSubSubj_Id")).FirstOrDefault();
                    if (OICId != 0)
                    {
                        if (OICId == Convert.ToInt32(ds.Tables[0].Rows[0]["CaseSubSubj_Id"]))
                        {
                            ddlCaseSubject_SelectedIndexChanged(sender, e);
                            ddlCaseSubSubject.ClearSelection();
                ...
                ddlCaseYear.ClearSelection();
                if (ddlCaseYear.Items.Count > 0)
                    ddlCaseYear.Items.FindByText(ds.Tables[0].Rows[0]["CaseYear"].ToString().Trim()).Selected = true;
                ddlCaseYear.Enabled = false;
