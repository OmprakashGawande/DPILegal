<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="WPDisposedCasesAnalysis.aspx.cs" Inherits="Legal_WPDisposedCasesAnalysis" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="margin-top: 2rem">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-primary btn-block" ValidationGroup="Save" OnClick="btnSearch_Click" Text="Search" />
                                        </div>
                                        <div class="col-md-5">
                                            <a href="WPDisposedCasesAnalysis.aspx" class="btn btn-default btn-block">Clear</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="GrdWPDisposedCasesAnalysis" runat="server" CssClass="datatable table table-bordered" EmptyDataText="NO RECORD FOUND" OnRowCommand="GrdWPDisposedCasesAnalysis_RowCommand" AutoGenerateColumns="false" DataKeyNames="Case_ID">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Year">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblYear" runat="server" Text='<%# Eval("CaseYear") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Case Direction type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOrderWithDirection" runat="server" Text='<%# Eval("OrderWithDirection") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Case Status" Visible="false">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEditView" runat="server" CommandArgument='<%# Eval("Case_ID") %>' CommandName="EditView" OnClientClick="aspnetForm.target ='_blank';" ToolTip="Edit" CssClass=""><i class="fa fa-edit"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: 'WP Disposed Cases Analysis',
                    exportOptions: {
