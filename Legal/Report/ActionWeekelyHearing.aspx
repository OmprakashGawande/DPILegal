<%@ Page Title="" Language="C#" MasterPageFile="~/Legal/MainMaster.master" AutoEventWireup="true" CodeFile="ActionWeekelyHearing.aspx.cs" Inherits="Legal_ActionWeekelyHearing" %>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <fieldset >
                            ...
                            <div class="row" id="Div_Appeal_YesNo" runat="server" visible="true">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Hearing Date</label>
                                        <asp:TextBox runat="server" ID="txtHearingDate" CssClass="form-control" AutoComplete="off"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Case listed<span style="color: red;"><b> *</b></span></label>
                                        <asp:RequiredFieldValidator ID="rfvCaselisted" ValidationGroup="Save"
                                            ErrorMessage="Select Case listed." ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Required !'></i>"
                                            ControlToValidate="ddlcaselisted" Display="Dynamic" runat="server" InitialValue="0">
                                        </asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlcaselisted" runat="server" CssClass="form-control">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Remark From DEO/OIC/Nodal</label>
                                        <asp:TextBox runat="server" ID="txtRemarkofDEO" CssClass="form-control" AutoComplete="off" placeholder="Enter Remark From DEO/OIC/Nodal"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Action Required</label>
                                        <asp:TextBox runat="server" ID="txtDEOActionRequired" CssClass="form-control" AutoComplete="off" placeholder="Enter Action Required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Remark from JD</label>
                                        <asp:TextBox runat="server" ID="txtRemarkfromJD" CssClass="form-control" AutoComplete="off" placeholder="Enter Remark from JD"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Action Required</label>
                                        <asp:TextBox runat="server" ID="txtJDActionRequired" CssClass="form-control" AutoComplete="off" placeholder="Enter Action Required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Remark from HOD/DPI</label>
                                        <asp:TextBox runat="server" ID="txtRemarkfromHOD_DPI" CssClass="form-control" AutoComplete="off" placeholder="Enter Remark from HOD/DPI"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Action Required</label>
                                        <asp:TextBox runat="server" ID="txtActionRequiredHOD_DPI" CssClass="form-control" AutoComplete="off" placeholder="Enter Action Required"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-2 " style="padding-top: 2rem! important;">
                                    <asp:Button ID="btnCaselisted" runat="server" CssClass="btn btn-primary" Text="Update" ValidationGroup="Save" OnClick="btnCaselisted_Click" />
                                </div>
                            </div>
                            <fieldset>
                                <legend>Detail
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GRVAppeal" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" EmptyDataText="NO RECORD FOUND">
                                            <Columns>
                                                <asp:TemplateField HeaderText="S.No.">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSrno" runat="server" Text='<%# Container.DataItemIndex + 1 %>'></asp:Label>
                                                ...
                                                <asp:BoundField HeaderText="Hearing Date" DataField="NextHearing" />
                                                <asp:BoundField HeaderText="Case listed" DataField="Caselisted" />
                                                <asp:BoundField HeaderText="Remark From DEO/OIC/Nodal" DataField="RemarkFromDEO_OIC_Nodal" />
                                                <asp:BoundField HeaderText="Action Required" DataField="DEO_ActionRequired" />
                                                <asp:BoundField HeaderText="Remark from JD" DataField="RemarkfromJD" />
                                                <asp:BoundField HeaderText="Action Required" DataField="JD_ActionRequired" />
                                                <asp:BoundField HeaderText="Remark from HOD/DPI" DataField="RemarkfromHOD_DPI" />
                                                <asp:BoundField HeaderText="Action Required" DataField="HOD_ActionRequired" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
                                </div>
